    ...
    <section id="about" class="about">
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-img">
                    <img src="https://images.unsplash.com/photo-1543269865-cbf427effbad?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Мұғалім портфолиосы">
                </div>
                <div class="about-text">
                    ...
                    <a href="Түйіндеме.pdf" class=""><i class="fas fa-download"></i>Резюмені жүктеу</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="achievements-grid">
                ...
                <div class="achievement-card">
                    ...
                    <p>Оқушыларым аудандық, облыстық, республикалық сайыстар мен олимпиадаларда жүлделі орындарға ие болып жүр. Соңғы 3 жылда 12 оқушымыз республикалық деңгейде жүлдегер атанды.</p>
                    <a href="#" class="btn btn-outline"><i class="fas fa-eye"></i>Қарау</a>
                </div>
                <div class="achievement-card">
                    <div class="achievement-icon"><i class="fas fa-chalkboard-teacher"></i></div>
                    <h3>Тәжірибе Алмасу</h3>
                    <p>Әдістемелік жұмыстарымды әріптестеріммен бөлісіп, тәжірибе алмасу алаңдарында баяндама жасаймын. Республикалық деңгейде 5 әдістемелік құралымның авторымын.</p>
                    <a href="#" class="btn btn-outline"><i class="fas fa-eye"></i>Қарау</a>
                </div>
            </div>
        </div>
